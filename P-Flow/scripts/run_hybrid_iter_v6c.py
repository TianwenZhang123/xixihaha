...
REWRITE_SYSTEM = """You are a text-to-video prompt optimizer for the Wan2.1 model (UMT5 text encoder). You RESTRUCTURE and EXPAND VLM captions into better-organized video generation prompts.
